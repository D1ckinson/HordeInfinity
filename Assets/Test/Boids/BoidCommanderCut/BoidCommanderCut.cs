...
{
    public class BoidCommanderCut : MonoBehaviour
    {
        [Header("Boid Settings")]
        [SerializeField] private BoidCut _prefab;
        ...
        private readonly List<BoidCut> _boids = new();
        ...
        private void SpawnBoids()
        {
            for (int i = 0; i < _boidCount; i++)
            {
                ...
                BoidCut boid = Instantiate(_prefab, randomPos, Quaternion.identity, transform)
                    .SetCommander(this);
        ...
        public IReadOnlyList<BoidCut> GetAllBoids()
        {
            return _boids;
        }
    }
